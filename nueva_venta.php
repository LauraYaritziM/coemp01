                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <h4 class="text-center">Datos del Operador</h4>
                                <a href="#" class="btn btn-primary btn_new_cliente"><i class="fas fa-user-plus"></i> Nuevo Operador</a>
                            </div>
                            <div class="card">
                                <div class="card-body">
                            ...
                            <h4 class="text-center">Datos Reporte</h4>
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label><i class="fas fa-user"></i> ADMINISTRADOR </label>
                                        <p style="font-size: 16px; text-transform: uppercase; color: #E38A36;"><?php echo $_SESSION['nombre']; ?></p>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                ...
                                <table class="table table-hover">
                                    <thead class="thead-dark">
                                        <tr>
                                            ...
                                            <th>Des.</th>
                                            <th>Stock</th>
                                            <th width="100px">Cantidad De Empaques</th>
                                            <th class="textright">Conos</th>
                                            <th class="textright">Conos Total</th>
                                            <th>Acciones</th>
                                        </tr>
                                        <tr>
