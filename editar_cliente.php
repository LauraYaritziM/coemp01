...
if (!empty($_POST)) {
  ...
  if (empty($_POST['nombre']) || empty($_POST['telefono']) || empty($_POST['direccion'])) {
    ...
    if ($resul >= 1) {
      $alert = '<p class"error">El RFC ya existe</p>';
    } else {
      if ($dni == '') {
        $dni = 0;
      }
      ...
      if ($sql_update) {
        $alert = '<p class"exito">Operador Actualizado correctamente</p>';
      } else {
        $alert = '<p class"error">Error al Actualizar el Operador</p>';
      }
    }
  }
}
            ...
            <div class="col-lg-6 m-auto">
              ...
              <form class="" action="" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="number" placeholder="Ingrese NSS" name="dni" id="dni" class="form-control" value="<?php echo $dni; ?>">
                </div>
                <div class="form-group">
