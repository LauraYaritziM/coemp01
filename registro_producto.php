     ...
     <div class="col-lg-6 m-auto">
       <form action="" method="post" autocomplete="off">
         ...
         <div class="form-group">
           ...
           <input type="text" placeholder="Ingrese el lote del producto" name="producto" id="producto" class="form-control">
         </div>
         <div class="form-group">
           <label for="precio">Conos</label>
           <input type="text" placeholder="Ingrese la cantidad de conos por empaque" class="form-control" name="precio" id="precio">
         </div>
         <div class="form-group">
           <label for="cantidad">Cantidad</label>
           <input type="number" placeholder="Ingrese cantidad de conos en inventario" class="form-control" name="cantidad" id="cantidad">
         </div>
