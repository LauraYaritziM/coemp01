...
if (!empty($_POST)) {
  ...
  if (empty($_POST['proveedor']) || empty($_POST['contacto']) || empty($_POST['telefono']) || empty($_POST['direccion'])) {
    ...
    if ($sql_update) {
      $alert = '<p class"msg_save">Máquina Actualizada correctamente</p>';
    } else {
    ...
    <div class="col-lg-6 m-auto">
      ...
      <form class="" action="" method="post">
        ...
        <div class="form-group">
          <label for="proveedor">Máquina</label>
        ...
        <div class="form-group">
          ...
          <input type="number" placeholder="Ingrese la cantidad de horas que la máquina puede operar" name="telefono" class="form-control" id="telefono" value="<?php echo $telefono; ?>">
        </div>
        <div class="form-group">
        ...
        <input type="submit" value="Editar Máquina" class="btn btn-primary">
      </form>
    </div>
  </div>
