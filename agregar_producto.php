        ...
        <div class="col-lg-6 m-auto">
            <form action="" method="post">
                ...
                <div class="form-group">
                    <label for="precio">Conos Actuales</label>
                    <input type="number" class="form-control" value="<?php echo $data_producto['precio']; ?>" disabled>
                </div>
                <div class="form-group">
                    <label for="precio">Cantidad de lotes Disponibles</label>
                    <input type="number" class="form-control" value="<?php echo $data_producto['existencia']; ?>" disabled>
                </div>
                <div class="form-group">
                    <label for="precio">Nuevo Cono</label>
                    <input type="number" placeholder="Ingrese nombre del cono" name="precio" class="form-control" value="<?php echo $data_producto['precio']; ?>">
                </div>
                <div class="form-group">
